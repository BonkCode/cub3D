...
#    Updated: 2020/09/03 14:12:18 by rtrant           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
parsing/config_error.c parsing/validation.c parsing/final_validation.c
CFLAGS			= -O3 -I. -Iparsing -Imlx -Iparsing/libft
CC				= gcc
MLX				= libmlx.dylib
